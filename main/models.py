...
class Employee(models.Model):
    ...
    role = models.CharField(max_length=100, choices=[('garson', 'Garson'), ('staff', 'Staff')])
...
class Address(models.Model):
    ...
    def clean_address(self):
        ...
        if not re.match(r'^[A-Za-z0-9]+$', self.address):
            raise ValidationError('Address must be a combination of letters and numbers, no spaces or special characters.')
